...
export async function getProfitDeskData(options?: { reportingMonth?: string | null }): Promise<ProfitDeskData> {
  ...
  const partsSummary: PartsSummary = {
    ...
    wholesaleGross: safeNumber(partsParsed.data.summary.gross.wholesale),
    gogGross: safeNumber(partsParsed.data.summary.gross.gog),
    totalGross: partsGross,
    grossLineMetrics: partsParsed.data.summary.grossMetrics,
